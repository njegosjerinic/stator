...
<section class="gradjevinarstvo">
    <div class="gradjevinarstvo-wrapper w1000">
        ...
        <div class="gradjevinarstvo-text-container " class="gradj-cont">
            <p>U toku je prodaja stanova u izgradnji, pogledajte ponudu stanova u stambenom objektu "ANA" u ulici Nikole Tesle u Doboju</p>
        </div>
        <div class="ana-caurousel">
            ...
            <div  class="ana-carousel-item">
                <img src="<?php echo get_theme_file_uri('images/viber_slika_2025-11-04_10-02-53-008.jpg'); ?>" alt="Ana Objekt">
            </div>
            <div class="ana-carousel-item">
                <img src="<?php echo get_theme_file_uri('images/viber_slika_2025-11-04_10-02-55-135.jpg'); ?>" alt="Ana Objekt">
            </div>
        ...
        <div class="ana-description-location">
            <h3>Lokacija</h3>
            <p>Stambeni objekat "ANA" se gradi u Doboju, u neposrednoj blizini trznog centra City Park i nove saobracajnice koja se proteze od bulevara do ulice Nikole Tesle</p>
